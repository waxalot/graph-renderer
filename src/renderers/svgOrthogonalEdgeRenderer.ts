import { IEdgeRenderer, SVGRenderer, IOrthogonalEdgeRenderer } from "./";
import { SVGEdgeViewModel, IOrthogonalEdgeViewModel, SVGOrthogonalEdgeViewModel } from "../viewModels";
